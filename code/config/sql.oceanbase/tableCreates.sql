...
create tablegroup vodka_group binding true partition by hash partitions 96;
...
(
    ...
    w_tax      decimal(4, 4),
    w_ytd      decimal(12, 2)
) tablegroup='vodka_group' partition by hash(w_id) partitions 96;
...
(
    ...
    d_ytd       decimal(12, 2),
    d_next_o_id integer
) tablegroup='vodka_group' partition by hash(d_w_id) partitions 96;
...
) tablegroup='vodka_group' partition by hash(c_w_id) partitions 96;
...
(
    ...
    h_data   varchar(24)
) tablegroup='vodka_group' partition by hash(h_w_id) partitions 96;
...
) tablegroup='vodka_group' partition by hash(no_w_id) partitions 96;
...
)  tablegroup='vodka_group' partition by hash(o_w_id) partitions 96;
...
) tablegroup='vodka_group' partition by hash(ol_w_id) partitions 96;
...
) tablegroup='vodka_group' partition by hash(s_w_id) partitions 96;
