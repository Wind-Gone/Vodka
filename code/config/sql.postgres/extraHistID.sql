...
-- select setval('vodka_hist_id_seq', (select max(hist_id) from vodka_history));
--
-- -- Make nextval(seq) the default value of the hist_id column.
-- alter table vodka_history
--     alter column hist_id set default nextval('vodka_hist_id_seq');
--
-- -- Add a primary key history(hist_id)
alter table vodka_history add primary key (hist_id);
